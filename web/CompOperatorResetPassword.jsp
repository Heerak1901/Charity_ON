<html>
    ...
    <body>
        ...
        <%@include file="ComplaintOperTopSection.jsp"%>    
        <br>
        <div class="divtheme1">
        <form action="CompOperResetPasswordPageJavaCode.jsp">
        <table width="40%" align="right" border="0" cellspacing="4" cellpadding="12" class="formtheme">
            ...
            <tr align="centre">
                <td>User ID</td>
                <td><input type="text" value="<%=session.getAttribute("CALL2") %>" name="id" placeholder="Enter ID" class="texttheme"></td>
            </tr>
            <tr align="centre">
                <td>Old Password</td>
