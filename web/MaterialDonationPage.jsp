<html>
    <head>
        ...
        <table width="40%" align="right" border="0" cellspacing="4" cellpadding="12" class="formtheme">
            ...
            <tr align="centre">
                <td>Material</td>
                <td><input type="address" name="material" placeholder="Enter the material you want to donate" class="texttheme"></td>
            </tr>
            
            <tr align="centre">
                <td>Contact Number </td>
                <td><input type="number" name="contact" placeholder="Enter contact number" class="texttheme"></td>
                </tr>
            
            <tr align="centre">
                <td>Address</td>
                <td><input type="address" name="address" placeholder="Enter your address" class="texttheme"></td>
            </tr>
